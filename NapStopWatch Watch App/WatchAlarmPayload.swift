...
// "NapStopWatch Watch App" (watchOS app) target.
//
// DELIBERATE DUPLICATE (2026-07-11): byte-identical to
// GeoAlarm/Models/WatchAlarmPayload.swift (main iOS target) and
// NapStopWatchWidget/WatchAlarmPayload.swift (complication target). See
// the header comment on the iOS copy for why — same reasoning as
